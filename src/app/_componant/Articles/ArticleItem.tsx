import {  ArticleItemProps } from '@/type/type'
...
export default function ArticleItem({article}:ArticleItemProps) {
  return (
   <div className="p-5 rounded-lg my-1 shadow-lg border-2 border-gray-400 hover:bg-slate-200 w-full md:w-2/5 lg:w-1/4">
            ...
            <Link href={`/articles/${article.id}`} className="text-xl bg-purple-700 hover:bg-purple-800 w-full block text-center p-1 text-white rounded-lg">Read More</Link>
          </div>
  )
}
